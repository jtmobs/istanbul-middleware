/*
 Copyright (c) 2024, Yahoo! Inc.  All rights reserved.
...
// You need to include babel/register or babel-core/register to transpile ES6+ code
...
function hookLoader(matcherOrRoot, opts) {
    ...
    transformer = function (code, filename) {
        // Use babel to transpile ES6+ code before instrumentation
        const babel = require('@babel/core');
        const transformed = babel.transformSync(code, {
            filename,
            presets: ['@babel/preset-env', '@babel/preset-react'], // Add any necessary presets
        });
        return instrumenter.instrumentSync(transformed.code, filename);
    };
